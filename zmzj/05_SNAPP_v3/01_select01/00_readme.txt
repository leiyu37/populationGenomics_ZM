(base) ev-nb026mc:01_select01 lyu$ ./01_prepare.py 
...
WARNING: The maximum number of SNPs has been set to 7000, which is greater
    than the number of bi-allelic SNPs with sufficient information (5761) for SNAPP.

INFO: Retained 5761 bi-allelic sites.
