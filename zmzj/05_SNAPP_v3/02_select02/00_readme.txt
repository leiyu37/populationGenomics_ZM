(base) ev-nb026mc:02_select02 lyu$ ./01_prepare.py 
...
WARNING: The maximum number of SNPs has been set to 7000, which is greater
    than the number of bi-allelic SNPs with sufficient information (6166) for SNAPP.

INFO: Retained 6166 bi-allelic sites.
